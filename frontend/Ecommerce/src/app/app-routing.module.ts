...
const routes: Routes = [
  ...
  { path: '', redirectTo: 'home', pathMatch: 'full' },
  { path: 'ordertracking/:orderId', component: OrderTrackingComponent, data: { breadcrumb: 'Order Tracking' } },
  { path: 'user-product-detail/:id', component: UserProductDetailComponent, data: { breadcrumb: 'Product Detail' } },
